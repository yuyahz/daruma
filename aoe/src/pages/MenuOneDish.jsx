                ...
                <Row className="MenuTitleSpace">
                    <Col>
                        <div className="MenuDeco">
                            <Image className="MenuDecoTitle" src={OnedishDeco} alt="Logo" fluid />
                        </div>
                    </Col>
                </Row>
                    ...
                    <Col md={{ span: 8, offset: 2 }}>
                        ...
                        <Row className="MenuSec" xs={1} md={1}>
                            <div className="MenuCap">
                                ...
                                <p className="MenuText"><span className="MenuTextSp"></span>¥600</p>
                            </div>
                            <div className="MenuCap">
                        ...
                        <Row className="MenuSec" xs={1} md={1}>
                            ...
                            <div className="MenuCap">
                                ...
                                <p className="MenuText"><span className="MenuTextSp"></span>¥270</p>
                            </div>
                            <div className="MenuCap">
